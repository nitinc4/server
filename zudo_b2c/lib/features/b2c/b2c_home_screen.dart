...
class _B2CHomeScreenState extends State<B2CHomeScreen> with WidgetsBindingObserver {
  bool _isLoading = true;
  int _currentIndex = 0;
  String _selectedCategory = 'All';
  final _pincodeController = TextEditingController();
  
  final GlobalKey _staplePicksKey = GlobalKey();
  ...
  void initState() {
    ...
    // Products are fetched by AppState constructor, but we can ensure it here
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    if (state == AppLifecycleState.inactive || state == AppLifecycleState.hidden) {
      ...
      print('B2C Session closed/paused after: ${sessionDuration.inSeconds}s');
      
      // 1. Low Session Time check (less than 30 seconds)
      if (sessionDuration < const Duration(seconds: 30)) {
        print('FCM: B2C low session detected. Triggering low_session FCM exit with token: $activeToken');
      ...
      if (appState.cart.isNotEmpty) {
        ...
        if (firstProdName != null) {
          print('FCM: B2C cart abandonment detected. First item: $firstProdName. Token: $activeToken');
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    key: _staplePicksKey,
                    child: _buildSectionTitle('Staple Picks'),
                  ),
                  const SizedBox(height: 16),
                ],
              ),
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            onTap: () {
              ...
              if (_staplePicksKey.currentContext != null) {
                Scrollable.ensureVisible(
                  _staplePicksKey.currentContext!,
  ...
  Widget _buildBannerSection() {
    ...
    return Container(
      ...
      child: ClipRRect(
        borderRadius: BorderRadius.circular(24),
        child: CachedNetworkImage(
          imageUrl: 'https://i.ytimg.com/vi/ydGuiCWM2k4/maxresdefault.jpg',
          fit: BoxFit.cover,
          placeholder: (context, url) => Container(color: AppColors.grey),
                      ...
                      Row(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text(
                                state.currentMode == AppMode.b2b ? '₹${product.b2bPrice}' : '₹${product.price}',
                                style: TextStyle(
