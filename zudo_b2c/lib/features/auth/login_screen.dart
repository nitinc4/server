...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    if (success) {
      if (appState.currentUser?.role != 'b2c') {
        appState.logout();
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('No Personal account found with these credentials.')),
          );
        }
      } else {
  ...
  Future<void> _handleGoogleSignIn() async {
    final appState = context.read<AppState>();
    final result = await appState.signInWithGoogle('b2c');
    ...
    if (result['newUser'] == true) {
      if (mounted) {
        Navigator.of(context).push(MaterialPageRoute(
          builder: (_) => const B2CSignupScreen(),
        ));
      }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      if (_isFetchingLocation)
                        const SizedBox(height: 14, width: 14, child: CircularProgressIndicator(strokeWidth: 2, color: AppColors.forestGreen))
                      else
                        Text(
              ...
              const Text(
                'Buy More Enjoy More',
                style: TextStyle(color: AppColors.lightText, fontSize: 16, fontStyle: FontStyle.italic),
              ),
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.person_outline_rounded, color: Colors.black54),
                ),
              ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: (_isFetchingLocation || appState.currentTenant == null) ? Colors.grey : AppColors.forestGreen,
                ...
                child: TextButton(
                  onPressed: appState.isLoading ? null : () => _onFormAction(() {
                    Navigator.of(context).push(
                      MaterialPageRoute(builder: (_) => const B2CSignupScreen()),
                    );
                  }),
                  child: const Text(
