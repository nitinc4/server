                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            _buildStatusBadge('Payment', order['paymentStatus'], _getPaymentStatusColor(order['paymentStatus'])),
                                          ],
                                        ),
                                      ],
                                    ),
        ...
        child: Column(
          ...
          children: [
            ...
            if (order['deliverySlot'] != null) ...[
              ...
              Row(
                children: [
                  const Icon(Icons.access_time_rounded, size: 14, color: AppColors.lightText),
                  const SizedBox(width: 8),
                  Text(
                    'Delivery Slot: ${order['deliverySlot']['startTime']} - ${order['deliverySlot']['endTime']}',
                    style: const TextStyle(color: AppColors.lightText, fontSize: 13, fontWeight: FontWeight.bold),
                  ),
                ],
              ),
            ],
