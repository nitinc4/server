...
class AppState extends ChangeNotifier {
  AppMode _currentMode = AppMode.b2b;
  ...
  double _minBillAmountB2B = 2000.0;
  ...
  double get minBillAmountB2B => _minBillAmountB2B;
  ...
  Future<void> fetchProducts() async {
    ...
    try {
      if (_token != null) {
        try {
          await ApiService.applyCommissions(_token!);
        } catch (e) {
          print('Apply commissions error: $e');
        }
      }
  ...
  Future<bool> register(Map<String, dynamic> userData) async {
    ...
    try {
      ...
      if (response.containsKey('token')) {
        ...
        // MOQ enforcement removed — minimum bill amount is checked at checkout
  ...
  Future<void> fetchMinimumBilling() async {
    ...
    try {
      ...
      _minBillAmountB2B = (data['minimumBillAmountB2B'] ?? 2000).toDouble();
      notifyListeners();
    } catch (e) {
  ...
  Future<bool> placeOrder(Map<String, dynamic> shippingAddress, String paymentMethod, {Map<String, dynamic>? deliverySlot}) async {
    ...
    try {
      try {
        ...
        print('Apply commissions at checkout error: $e');
      }
      ...
      final orderData = {
        ...
        if (deliverySlot != null) 'deliverySlot': {
          'id': deliverySlot['_id'] != null ? (deliverySlot['_id'] is Map ? deliverySlot['_id']['\$oid'] : deliverySlot['_id'].toString()) : null,
  ...
  Future<void> _loadFromPrefs() async {
    ...
    if (modeStr != null) {
      _currentMode = AppMode.values.firstWhere((e) => e.name == modeStr, orElse: () => AppMode.b2b);
    }
  ...
  Future<void> _saveToPrefs() async {
    ...
    if (_currentUser != null) {
      await prefs.setString('user', jsonEncode({
        ...
        'businessAddress': _currentUser!.businessAddress,
        ...
        'salesAssociate': _currentUser!.salesAssociate,
        'bankDetails': _currentUser!.bankDetails,
      }));
    }
